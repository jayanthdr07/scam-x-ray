You are a senior UI/UX designer and frontend design-system engineer.

I have an existing application called:

SCAMTRACE
"Don't just detect the scam. Trace it."

IMPORTANT:
THIS TASK IS ONLY ABOUT UI/UX.
...
Your job is to completely redesign the visual interface and user experience so SCAMTRACE feels like a polished, premium cybersecurity SaaS product.
...
- sections do not flow naturally
- too much information visible at once
- typography hierarchy is weak
- some text is too small
- buttons and icons do not align properly
- risk information does not have enough visual hierarchy
- the page feels like many AI-generated components placed together
- the user has to work too hard to understand what to do

Completely fix these problems.

DO NOT simply change the colors.

This is a full UI/UX redesign.

==================================================
CORE UX PRINCIPLE
==================================================

The user should understand SCAMTRACE within 5 seconds.
...
Do NOT use hacker-movie aesthetics.

Do NOT use random decorative graphics.

The application should look like a real cybersecurity product, not a student dashboard.

==================================================
DESIGN REFERENCES
==================================================

Use the existing SCAMTRACE screenshots in this conversation as a reference for the current application structure.

Improve them substantially.

Do NOT copy the current visual arrangement.

The new design should be cleaner, more spacious, and easier to scan.

==================================================
TYPOGRAPHY
==================================================

Use one consistent modern font.
...
Do not use tiny text just to fit information.
...
The current icons are poorly aligned and inconsistent.

Replace the existing icon system with ONE consistent icon library.
...
Never randomly use different icon sizes.

==================================================
ICON ALIGNMENT RULE
==================================================

Every icon/text combination must use:

display: flex;
align-items: center;

Icons must be vertically centered with text.

Use fixed icon containers when necessary:
...
The icon itself should be centered inside.
...
ICON
TEXT slightly above/below it

Never put oversized icons beside small text.
...
Use it consistently throughout the application.
...
Sections should have consistent vertical rhythm.

Create a reusable design system rather than styling every component independently.
...
Do not allow content to stretch across the entire screen.
...
AI-POWERED JOB OFFER INVESTIGATION
...
Then a simple four-step visual:

DETECT → VERIFY → TRACE → PROTECT

Do NOT make four giant cards.

Use a compact horizontal progression.

==================================================
MAIN SCANNER
==================================================

The scanner must become the visual center of the homepage.

Use ONE large clean card.
...
Paste a job offer, recruiter message or email...
...
[ Search icon ] Investigate Offer

Make this button visually dominant.

==================================================
SCANNER LAYOUT
==================================================

Do NOT put everything inside multiple nested cards.

Use:

ONE outer scanner card
...
The results page needs a complete information hierarchy.

Do NOT display every feature as an equal-sized card.
...
This should be the most visually important component.

Create ONE large summary panel.
...
"Multiple high-risk indicators were detected, including a payment request, urgency, and sensitive-data collection."
...
Do NOT create huge cards for every flag.
...
┌────────────────────────────────────────────┐
│ payment icon   Payment Request       +25   │
│                ₹12,500 deposit             │
├────────────────────────────────────────────┤
│ clock icon     Urgency               +15   │
│                2-hour deadline             │
├────────────────────────────────────────────┤
│ shield icon    Sensitive Data        +20   │
│                Aadhaar + bank details     │
└────────────────────────────────────────────┘

Each row is clickable.

Clicking a row opens the relevant evidence.

Icons must be perfectly aligned.
...
Original content/document.

RIGHT:

Evidence details.

When the user clicks a red flag:

highlight the corresponding evidence.
...
"Requests for payment before employment can indicate advance-fee fraud."
...
Do not overwhelm users with technical text.
...
Do not make this look like another giant dashboard.
...
Do not create six separate giant cards.

==================================================
PATTERN LIBRARY
==================================================

Create a clean separate page.
...
Pattern cards should be compact.
...
AI Red Team and Risk Simulator should NOT dominate the primary result.
...
This keeps the primary experience simple.

==================================================
PROTECTION PLAN
==================================================

This should be a clean final section.
...
02
Do not share OTPs or financial credentials.

03
Verify the company independently.

04
Use the official company website to contact HR.
...
Create one unified card system.
...
Create one unified button system.

Primary:
solid accent

Secondary:
subtle outline/transparent
...
Do not manually create dozens of different badge designs.
...
Why SCAMTRACE flagged this

"The strongest signals detected in the submitted offer."
...
Threat Index centered.

Evidence stacked.

Attack Chain vertical.
...
DO NOT redesign by simply putting the existing components into different colors.
...
Use Tailwind or the project's existing styling system consistently.
...
Only improve their presentation and interaction.

==================================================
FINAL UI AUDIT
==================================================

Before finishing, inspect EVERY PAGE and EVERY COMPONENT.
...
[ ] No emoji mixed with Lucide icons
...
[ ] Threat Index is immediately understandable

[ ] Evidence is easy to scan

[ ] Attack Chain is easy to follow

[ ] Verification is easy to understand

[ ] Advanced features do not overwhelm the user
...
SCAMTRACE should feel like:

A REAL CYBERSECURITY PRODUCT

NOT:

A COLLECTION OF AI-GENERATED UI CARDS.
...
The user should be able to open SCAMTRACE and immediately understand:

"What do I upload?"

"What did SCAMTRACE find?"

"Why did it flag this?"

"What should I do?"

Start by auditing the existing frontend, then perform the UI/UX redesign systematically.

DO NOT modify backend functionality.
DO NOT modify AI logic.
DO NOT modify scoring logic.
ONLY redesign and improve the UI/UX.
Give me complete read me copy paste.... Include all well structured and no emoji. All feature and unique more impactfull readme ensure all 
# SCAMTRACE
...
- [Scam Attack Chain](#scam-attack-chain)
- [Google-Powered Verification](#google-powered-verification)
- [Scam DNA](#scam-dna)
- [AI Red Team](#ai-red-team)
- [Risk Simulator](#risk-simulator)
- [Scam Pattern Library](#scam-pattern-library)
...
The AI does not simply return a single classification.

It produces structured evidence that can be independently displayed and evaluated by the application.
...
Users can submit suspicious recruitment URLs for analysis.
...
A request for payment before employment can be an indicator
of advance-fee recruitment fraud.
...
INFERENCE
What the detected signal may indicate.
...
Payment Request
₹12,500 refundable deposit
+25

Urgency
Offer expires within two hours
+15

Sensitive Information
Aadhaar and bank information requested
+20
...
SCAMTRACE does not only identify individual red flags.

It attempts to reconstruct the potential progression of the interaction.
...
Establishes credibility and creates an expectation of employment.

Stage 2: Urgency

Evidence:

"Complete this process within two hours."

Purpose:

Creates pressure and discourages independent verification.
...
Introduces a financial request.

Stage 4: Data

Evidence:

"Submit your Aadhaar and bank details."
...
SCAMTRACE does not automatically classify a company as fraudulent simply because a job or recruiter cannot be found.
...
Submitted Domain:
example-careers-support.com

Potential Concern:
Domain does not clearly correspond to the claimed company.
...
Users can search and filter patterns.

The library also allows users to test patterns using the scanner.
...
The system can also show related patterns.

This connects the live investigation with the Pattern Library.
...
A second AI evaluation acts as a skeptical reviewer.
...
Supporting Evidence
Payment request and urgency detected.

Counter-Evidence
No explicit credential request detected.

Missing Information
Recruiter identity could not be independently verified.

Potential False Positive
High salary alone is not sufficient evidence of fraud.
...
The user can disable individual signals.

The deterministic scoring engine immediately recalculates the score.
...
This provides transparent score explainability.

Users can understand which signals have the greatest influence on the assessment.
...
SCAMTRACE does not stop after detection.
...
The application still runs the real analysis pipeline rather than displaying a pre-generated final score.
...
Gemini is responsible for extracting and classifying evidence.

The deterministic engine is responsible for calculating the primary threat score.
...
SCAMTRACE follows a data-minimization approach.

Users should avoid uploading unnecessary personal information.
...
Designed for deployment using Google Cloud / Firebase infrastructure.
...
Unusual communication platform
No formal interview
Immediate offer
...
but no other suspicious evidence.
...
Official-domain claim

Expected:

Low Detected Risk

The system should still state:

Low detected risk does not prove legitimacy.
Test 6: Screenshot
...
Upload a suspicious fictional job offer.

Step 2

SCAMTRACE analyzes the content.
...
Show the exact suspicious statements.
...
Show independently sourced company information.
...
Show counter-evidence and missing information.
...
This demonstrates the complete SCAMTRACE philosophy:
...
DATA
Submit Aadhaar and bank information.
...
SCAMTRACE does not ask the user to blindly trust an AI score.

It gives the user evidence and context.
...
Gemini extracts the signals.

A deterministic rules engine calculates the score.

This creates a transparent relationship between evidence and risk.
...
SCAMTRACE challenges its own initial assessment.
...
Users can interactively see how individual signals affect the score.

This makes the threat engine understandable rather than mysterious.
...
The system answers the most important question after detection:
...
The platform aims to reduce the gap between:

Receiving a suspicious offer

and:

Understanding whether the offer deserves further verification.
...
Users should understand the result immediately.

Explainability

Every important risk should have supporting evidence.

Transparency

The scoring mechanism should be understandable.

Verification

Important claims should be independently checked where possible.

Uncertainty

Unknown information should remain unknown instead of being invented.

Safety

The platform should provide practical next steps.
...
The system therefore uses structured outputs, evidence requirements, and deterministic scoring where possible.

Public Information Limitations

A company or recruiter may have limited online information.

Failure to find information does not automatically prove fraud.
...
Poor-quality scans or images may reduce analysis accuracy.

Domain Limitations

Domain-registration information may not always be available through allowed sources.

Verification Limitations

Public web information can be outdated or incomplete.

Therefore, SCAMTRACE uses language such as:
...
Metadata would be treated as supporting evidence rather than proof of fraud.

Corporate Template Analysis

Compare document structure and branding against publicly available corporate material where appropriate.

Job Verification

Compare claimed positions with publicly available company career listings.

Community Intelligence

Create an anonymized community database of reported recruitment scam patterns.

Potential signals:

Scam recruiter identifiers
Suspicious domains
Repeated scam messages
Reported payment patterns
Continuous Scam Pattern Learning

Expand the Pattern Library as new recruitment scam techniques emerge.
...
The product does not simply attempt to tell users what to think.

It gives them structured evidence so they can make better-informed decisions.
